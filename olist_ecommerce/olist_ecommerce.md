...
### 2.1 매출 상위 품목 분석
🔸 결론 : 매출 상위 품목들로 범위를 제한하여 분석을 진행합니다.📍📌💡🔎

품목별 매출과 해당 매출이 전체 매출에서 차지하는 비율 누적 그래프입니다. 빨간선은 누적 비율 80% 기준선입니다.

**전체 거래 금액의 약 80%가 매출 상위 15개 품목에서 발생**하고 있습니다. 
...
🔸 결론 : 빠른 배송(23일 기준)을 제공할 수 있도록 지역을 선택해야 합니다.
